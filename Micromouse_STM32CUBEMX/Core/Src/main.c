...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : IMU_INT_Pin DRDY_Pin */
  GPIO_InitStruct.Pin = IMU_INT_Pin|DRDY_Pin;
  ...
  /*Configure GPIO pin : USER_BUTT1_Pin */
  GPIO_InitStruct.Pin = USER_BUTT1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(USER_BUTT1_GPIO_Port, &GPIO_InitStruct);
