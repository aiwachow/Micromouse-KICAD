...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOC, PhotoT_1_Pin|PhotoT_2_Pin|PhotoT_3_Pin);

    HAL_GPIO_DeInit(GPIOA, PhotoT_6_Pin|PhotoT_5_Pin|PhotoT_4_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB9     ------> TIM4_CH4
    */
    HAL_GPIO_DeInit(GPIOB, TIM_ENCODER_B1_Pin|TIM_ENCODER_A1_Pin|TIM_ENCODER_B2_Pin|TIM_ENCODER_A2_Pin);
